...
class TiChartCrossPictorialBar extends TiAbstractChartType {
    ...
    createChart(isFirst) {
            ...
            series: [
                {
                    ...
                    // symbolOffset: [baseMethods.getSize(0), 0],
        ...
        this.initChart(options, "getCrossPictorialBarOption",isFirst);
    }
    /**
     * @description 改变图表数据
    ...
    changeChartStyle(style) {
        let convertStyle = this.convertStyleData(style, "getCrossPictorialBarOption");
