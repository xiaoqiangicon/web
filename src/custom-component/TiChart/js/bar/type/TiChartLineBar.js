 ...
 */
class TiChartLineBar extends TiAbstractChartType {
    constructor(option) {
        super(option);
    }
    /**
    ...
    createChart(isFirst) {
        ...
        this.initChart(options, "getLineBarOption",isFirst);
    }
    /**
     * @description 改变图表数据
    ...
    changeChartStyle(style) {
        let convertStyle = this.convertStyleData(style, "getLineBarOption");
        this.option.styleData = baseMethods.assiginObj(this.option.styleData, convertStyle);
        this.createChart(true);
    }
}
export default TiChartLineBar;
