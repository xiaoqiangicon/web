    ...
    methods: {
        ...
        handleMouseDownOnShape(e) {
            ...
            const move = (moveEvent) => {
                ...
                pos.top =  this.boundaryLimit(curY - startY + startTop,this.canvasStyleData.scale/100*this.canvasStyleData.height-height)
                pos.left =this.boundaryLimit(curX - startX + startLeft,this.canvasStyleData.scale/100*this.canvasStyleData.width-width) 
